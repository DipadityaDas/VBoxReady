...
After the system reboot automatically, if we again go to `msinfo32.exe` and Select System Information, then we will see that the Hyper-V Requirement doesn't shows the previous image. 